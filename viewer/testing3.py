...
if __name__ == '__main__':
    ...
    with open(csv_filename, 'w', newline='') as csvfile:
        ...
        csv_writer.writerow([
            'Timestamp',
            'LeftGazeX', 'LeftGazeY',
            'RightGazeX', 'RightGazeY',
            'CombinedGazeX', 'CombinedGazeY'
        ])
        ...
        while (enable):
            ...
            csvfile.write(
                ...
                f"({left_image_point[0]:.2f},{left_image_point[1]:.2f}),"
                f"({right_image_point[0]:.2f},{right_image_point[1]:.2f}),"
                f"({combined_image_point[0]:.2f},{combined_image_point[1]:.2f})\n"
            )
