...
# Lade das vortrainierte Haar-Cascade-Modell
...
if (mode == hl2ss.StreamMode.MODE_2):
    ...
    while (enable):
        ...
        gray = cv2.cvtColor(data.payload.image, cv2.COLOR_BGR2GRAY)
        faces = face_cascade.detectMultiScale(gray, 1.3, 5)

        for (x, y, w, h) in faces:
            cv2.rectangle(data.payload.image, (x, y), (x + w, y + h), (255, 0, 0), 2)
