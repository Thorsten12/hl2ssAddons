...
def pv_view(queue, shared_queue):
...
def main():
    ...
    # Set Surfaces
    dummy_dict = SM_convert.sm_mesh_to_sm_manager("C:/Users/Tsyri/OneDrive/Desktop/hl2ssAddons/hl2ss2_27_04/hl2ssAddons/viewer/meshes/sphere.ply")
    ...
    pv_thread = threading.Thread(target=pv_view, args=(queue, shared_queue))
    pv_thread.start()
